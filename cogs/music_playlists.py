...
#  Playlist Commands
#  ---------------------------------------------------------------------------------------------------------------------
    @app_commands.command(name="create_playlist", description="Create a new music playlist")
    ...
    @app_commands.command(name='add_to_playlist', description='Add a song to a specific playlist')
    @app_commands.autocomplete(playlist=autocomplete_playlists)
    ...
    @app_commands.command(name='remove_song', description='Remove a song from a playlist')
    @app_commands.autocomplete(playlist=autocomplete_playlists)
