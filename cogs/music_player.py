...
#  ---------------------------------------------------------------------------------------------------------------------
    ...
    async def upload_image(self, image_bytes, channel_id=1276907662554173512):
    ...
    async def generate_and_upload_progress_images(self):
        channel = self.bot.get_channel(1359233906536218765)
        async with aiosqlite.connect(db_path) as db:
...
#  ---------------------------------------------------------------------------------------------------------------------
    ...
    async def play(self, interaction: discord.Interaction, song: str):
        ...
        await self.update_player(interaction)
        await interaction.followup.send(f"`Success: Added {info['title']} to the queue.`")
